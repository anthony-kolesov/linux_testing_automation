...
echo "echo 'Working under directory'" >>run.csh
echo "pwd" >>run.csh
echo "${workarea}/automated_scripts/linux/linux_build.pl -config $config -config_file $configfile -testconfig $testconfig" >>run.csh
chmod 755 run.csh
